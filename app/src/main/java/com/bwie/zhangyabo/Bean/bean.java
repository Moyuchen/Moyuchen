package com.bwie.zhangyabo.Bean;

import java.util.List;

/**
 * User: 张亚博
 * Date: 2017-11-06 09:29
 * Description：
 */
public class bean {
    ...
    public static class SongListBean {
        ...
        private boolean CBVisibla;

        public boolean isCBVisibla() {
            return CBVisibla;
        }

        public void setCBVisibla(boolean CBVisibla) {
            this.CBVisibla = CBVisibla;
        }
